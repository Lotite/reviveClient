    ...
    >
      ...
      >
        <div className="relative">
          ...
          <div className="relative w-[300px] h-[200px] lg:w-[500px] lg:h-[300px]  bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl p-3 shadow-2xl border border-slate-700/50">
